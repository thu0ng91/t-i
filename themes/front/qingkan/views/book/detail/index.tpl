...
<div class="sy_contain">
    <div class="sy_left">
        <div class="sy_kuang01">
            ...
            <div class="sy_nr02">
                <div class="sy_nr02_left"><a href="{novel_chapter_link bookid=$book->id id=$book->lastchapterid pinyin=$book->pinyin}"><img border="0" src="{$book->coverImageUrl}"></a></div>
                <div class="sy_nr02_right">
                    ...
                    <div class="sy_anniu" id="keyword">
                        <span class="sy_zstb">最新章节</span><a href="{novel_chapter_link bookid=$book->id id=$book->lastchapterid pinyin=$book->pinyin}">{$book->lastchaptertitle}</a> {$book->updatetime|date_format:'Y-m-d H:i:s'}
                    </div>
        ...
        {foreach $chapters as $chapter}
            <div class="chapter-i"><a href="{novel_chapter_link bookid=$book->id id=$chapter->id pinyin=$book->pinyin}">{$chapter->title}</a></div>
        {/foreach}
        <div class="clear"></div>
        </div>
    </div>
