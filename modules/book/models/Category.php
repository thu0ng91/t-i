...
class Category extends BaseModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, isnav,parentid, type, sort, status, createtime, updatetime', 'numerical', 'integerOnly'=>true),
			...
			array('id, title, parentid, type, seotitle, keywords, description, sort, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            'parent' => array(CActiveRecord::BELONGS_TO, 'Category', 'parentid'),
		);
	}
...
//			'mark' => '标识',
	...
	public function showAllSelectCategory($selectText='')
	{
		...
		$category=Category::model()->select('id,title,parentid')->order('sort desc')->findAll($criteria);
		$categoryList=array();
