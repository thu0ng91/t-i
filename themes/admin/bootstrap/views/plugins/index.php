...
<?php $this->widget('bootstrap.widgets.TbButton', array(
    ...
    'label'=>'查找本地插件',
    'url' => $this->createUrl('plugins/scan'),
...
//        array('name'=>'id', 'header'=>'#'),
        array('name'=>'id', 'header' => '插件编号', 'filter' => false),
        array('name'=>'title', ),
        array('name'=>'version', ),
//        array(
//            'name'=>'imgurl',
...
//        array('name'=>'createtime', 'value' => 'date("Y-m-d H:i:s", $data->createtime)', 'filter' => false),
        array(
            ...
            'buttons' => array(
                'setup' => array(
                    'label'=>'安装该插件',     // text label of the button
                    'url'=>'Yii::app()->controller->createUrl("plugins/setup",array("id"=>$data->id))',       // a PHP expression for generating the URL of the button
                ...
                'start' => array(
                    'label'=>'启用该插件',     // text label of the button
                    'url'=>'Yii::app()->controller->createUrl("plugins/start",array("id"=>$data->id))',       // a PHP expression for generating the URL of the button
                    'imageUrl'=> '',  // image URL of the button. If not set or false, a text link is used
                    'icon' => 'play',
                    'options'=> array('style'=>'cursor:pointer;'), // HTML options for the button tag
                    'click'=> 'js:function () {ajaxPost($(this).attr("href"));return false;}',     // a JS function to be invoked when the button is clicked
                ...
                'stop' => array(
                    'label'=>'停止该插件',     // text label of the button
                    'url'=>'Yii::app()->controller->createUrl("plugins/stop",array("id"=>$data->id))',       // a PHP expression for generating the URL of the button
                    'imageUrl'=> '',  // image URL of the button. If not set or false, a text link is used
                    'icon' => 'off',
                    'options'=> array('style'=>'cursor:pointer;'), // HTML options for the button tag
                    'click'=> 'js:function () {ajaxPost($(this).attr("href"));return false;}',     // a JS function to be invoked when the button is clicked
                ...
                'upgrade' => array(
                    'label'=>'升级该插件',     // text label of the button
                    'url'=>'Yii::app()->controller->createUrl("plugins/upgrade",array("id"=>$data->id))',       // a PHP expression for generating the URL of the button
                    'imageUrl'=> '',  // image URL of the button. If not set or false, a text link is used
                    'icon' => 'upload',
                    'options'=> array('style'=>'cursor:pointer;'), // HTML options for the button tag
                    'click'=> 'js:function () {ajaxPost($(this).attr("href"));return false;}',     // a JS function to be invoked when the button is clicked
                ...
                'delete' => array(
                    'label'=>'删除该插件',     // text label of the button
                    'url'=>'Yii::app()->controller->createUrl("plugins/delete",array("id"=>$data->id))',       // a PHP expression for generating the URL of the button
                    'imageUrl'=> '',  // image URL of the button. If not set or false, a text link is used
//                    'icon' => 'stop',
                    'options'=> array('style'=>'cursor:pointer;'), // HTML options for the button tag
