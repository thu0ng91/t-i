...
<div class="bookstoretwo">
    <div class="twoleft">
        <div class="storelistbt">
            <div class="storelistbt1">关键字 {$keyword|strip_tags} 共找到{$pages->itemCount}个搜索结果</div>
    ...
    <div class="tworight">
        <div id="list1" class="list1a">
            <div style="CURSOR: pointer" id="heada" class="list3" onclick="listTab('list_a','heada')">最近更新</div>
