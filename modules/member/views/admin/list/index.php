...
<?php $this->widget('bootstrap.widgets.TbButton', array(
    'label'=>'新建会员',
    'url' => Yii::app()->createUrl('member/admin/list/create'),
...
////        array('name'=>'language', 'header'=>'Language'),
        ...
        array(
            ...
            'buttons' => array(
                'update' => array(
                    'label'=>'编辑会员',     // text label of the button
                    'url'=>'Yii::app()->createUrl("member/admin/list/update",array("id"=>$data->id))',       // a PHP expression for generating the URL of the button
...
//                    'click'=> 'js:function(){}',     // a JS function to be invoked when the button is clicked
                ...
                'delete' => array(
                    'label'=>'删除会员',     // text label of the button
                    'url'=>'Yii::app()->createUrl("member/admin/list/delete",array("id"=>$data->id))',       // a PHP expression for generating the URL of the button
                    'imageUrl'=> '',  // image URL of the button. If not set or false, a text link is used
//                    'icon' => 'eye-open',
                    'options'=> array('style'=>'cursor:pointer;'), // HTML options for the button tag
//                    'click'=> 'js:function(){}',     // a JS function to be invoked when the button is clicked
...
//                    'url'=>'Yii::app()->createUrl("list/admin/volume/index",array("listid"=>$data->id))',       // a PHP expression for generating the URL of the button
//                    'imageUrl'=> '',  // image URL of the button. If not set or false, a text link is used
//                    'icon' => 'list',
//                    'options'=> array('style'=>'cursor:pointer;'), // HTML options for the button tag
//                    'click'=> 'js:function(){}',     // a JS function to be invoked when the button is clicked
...
//                    'url'=>'Yii::app()->createUrl("list/admin/chapter/index",array("listid"=>$data->id))',       // a PHP expression for generating the URL of the button
//                    'imageUrl'=> '',  // image URL of the button. If not set or false, a text link is used
//                    'icon' => 'list',
//                    'options'=> array('style'=>'cursor:pointer;'), // HTML options for the button tag
//                    'click'=> 'js:function(){}',     // a JS function to be invoked when the button is clicked
